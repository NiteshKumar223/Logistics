        ...
        child: Padding(
          ...
          child: Column(
              ...
              children: <Widget>[
                ...
                Indicator(no: 1,clr: AppColor.colorDarkGray, itemName: "Receive Pickup"),
                const Indicator(no:2,clr: AppColor.colorPrimary, itemName: "On the way"),
                const Indicator(no:3,clr: Colors.green, itemName: "Successful delivery"),
                Indicator(no:4,clr: AppColor.colorBlue, itemName: "Forworded shipment"),
                Indicator(no:5,clr: AppColor.colorRed, itemName: "Delivery Details"),
                Indicator(no:6,clr: AppColor.colorPrimaryLight, itemName: "Returns"),
...
class Indicator extends StatelessWidget {
  ...
  final int no;
  const Indicator({super.key,required this.clr,required this.itemName,required this.no});
